(ns top.kzre.homunculus.core.ir2.pass.fold.core
  "常量折叠与传播的迭代入口。"
  (:require
   [top.kzre.homunculus.core.ir2.pass.fold.fold :as fd]
   [top.kzre.homunculus.core.ir2.pass.fold.mutable :as mutable]
   [top.kzre.homunculus.core.ir2.pass.fold.propagate :as fp]
