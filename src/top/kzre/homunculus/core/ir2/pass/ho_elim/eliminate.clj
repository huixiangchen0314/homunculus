(ns top.kzre.homunculus.core.ir2.pass.ho-elim.eliminate
  "高阶函数内联 Pass：标记并内联高阶函数。
  使用 reduce-children + walk 模式，ho-elim-fn 绝不递归子节点。"
  (:require
   [top.kzre.homunculus.core.ir2.node :as n]
   [top.kzre.homunculus.core.ir2.ast :as p]
   [top.kzre.homunculus.core.ir2.pass.ho-elim.analyze :as analyze]
...
(defn elim-nodes
  [nodes context]
  (let [analyzed-roots (analyze/analyze nodes)
