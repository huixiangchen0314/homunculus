...
(defast IRStmt
        ...
        :while           [:expr 'test :block 'body 'attrs]
        ...
        :catch           ['class 'sym :block 'body 'attrs]
        :field           ['name 'attrs]
        :method          ['name :params 'params :block 'body {:optional true} 'docstring 'attrs]
        ...
        :try             [:block 'body {:optional true} :catches 'catches :block 'finally {:optional true} 'attrs]
